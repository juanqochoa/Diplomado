...
# Introducir valores faltantes, para luego imputarlos
...
#El método KNN sirve para cuando la variable que tiene datos faltantes tiene correlación fuerte con otra variable, 
# utiliza datos cercanos como en la interpolación
